import sys
import numpy as np
from ActuatorAndGearbox_INWPG_independent import motor
from ActuatorAndGearbox_INWPG_independent import material
from ActuatorAndGearbox_INWPG_independent import inrunnerWolfromPlanetaryGearbox
from ActuatorAndGearbox_INWPG_independent import inrunnerWolfromPlanetaryActuator
from ActuatorAndGearbox_INWPG_independent import optimizationInrunnerWolfromPlanetaryActuator
import os
import json
...
inwpg_params_path = os.path.join(current_dir, "config_files/inwpg_params_independent.json")
