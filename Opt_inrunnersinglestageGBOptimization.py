...
#--------------------------------------------------------
# APPLIED GEOMETRIC RULE: Gearbox OD = Stator OD + (Stator Casing Thickness * 2)
...
Actuator_RI100 = singleStagePlanetaryActuator(
    design_params            = sspg_design_params,
    motor                    = MotorRI100, 
    motor_driver_params      = None, # Passed dynamically or None if unused
...
#=============================================================
# Run execution function (Mirrors ICPG Structure)
#=============================================================
def run(m_name, gear_ratio):
    if m_name == "RI100":
...
if __name__ == "__main__":
    ...
    # Run the optimization for Gear Ratio = 0 (Will loop through all based on bounds)
    totalTime_RI100, _ = run("RI100", 0)
