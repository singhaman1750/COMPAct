...
# ╚══════════════════════════════════════════════════════════════════════════╝
class material:
    """Stores material properties used in gear stress and mass calculations."""
...
# ╔══════════════════════════════════════════════════════════════════════════╗
# ║  BEARING CATALOGUE  (discrete ID → nearest available standard bearing)  ║
# ╚══════════════════════════════════════════════════════════════════════════╝
class bearings_discrete:
    """
    Looks up the smallest standard bearing whose inner diameter >= idRequiredMM.
    Table columns: [ID_mm, OD_mm, width_mm, mass_kg]
    """
...
# ╔══════════════════════════════════════════════════════════════════════════╗
# ║  NUTS AND BOLTS  (socket-head and CSK head / nut dimension tables)      ║
# ╚══════════════════════════════════════════════════════════════════════════╝
class nuts_and_bolts_dimensions:
    """
    Returns standard head and nut dimensions for a given metric bolt diameter.
    Supported bolt_type values: 'socket_head' | 'CSK'
    """
