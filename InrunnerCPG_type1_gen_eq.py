...
class inrunnerCompoundPlanetaryActuator:
    ...
    def setVariables(self):
       ...
       # self.case_mounting_nut_clearance                = self.design_params["case_mounting_nut_clearance"]                # 2
        ...
        # --- Ring ---
        self.ring_radial_width = self.design_params["ringRadialWidthMM"] # 5
        ...
        self.fw_r    = self.inrunnerCompoundPlanetaryGearbox.fwRingMM
    ...
    def getMassKG_3DP(self):
        ...
        planet2FwMM = self.inrunnerCompoundPlanetaryGearbox.fwPlanetSmallMM
        ringFwMM    = self.inrunnerCompoundPlanetaryGearbox.fwRingMM
        ...
        RingOuterRadiusMM = RadiusRingMM + module2 + self.inrunnerCompoundPlanetaryGearbox.ringRadialWidthMM
        ...
        case_mounting_structure_OD     = (Ns+2*Np1)*module1 + 2*standard_clearance_1_5mm + 2*ring_radial_thickness
        case_mounting_structure_ID     = case_mounting_structure_OD - 2*ring_radial_thickness
        ...
        ring_casing_chamfer_height = ringFwUsedMM - ring_radial_thickness
        ...
        if (motor_OD - (((Ns + 2*Np1) * module1) + 2*standard_clearance_1_5mm + 2*ring_radial_thickness)) > (standard_clearance_1_5mm + planet1FwMM + clearance_planet + sec_carrier_thickness) / 2 :
            large_fillet_height = (standard_clearance_1_5mm + planet1FwMM + clearance_planet + sec_carrier_thickness) / 2
        else:
            large_fillet_height = motor_OD - (((Ns + 2*Np1) * module1) + 2*standard_clearance_1_5mm + 2*ring_radial_thickness) 
